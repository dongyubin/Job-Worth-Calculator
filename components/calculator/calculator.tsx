...
const SalaryCalculator = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (hostname !== 'jobworthcalculator.wwkejishe.top' && hostname !== 'localhost' && !hostname.includes('127.0.0.1')) {
        window.location.href = 'https://jobworthcalculator.wwkejishe.top' + window.location.pathname;
      }
    }
  }, []);
