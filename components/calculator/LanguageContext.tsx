...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'theme_color_blue': '商务蓝',
    'theme_color_green': '自然绿',
    'theme_color_purple': '神秘紫',
    'theme_color_pink': '浪漫粉',
    'theme_applies_immediately': '主题更改将立即生效',
  ...
  en: {
    ...
    'theme_color_orange': 'Vibrant Orange',
    'theme_color_blue': 'Business Blue',
    'theme_color_green': 'Nature Green',
    'theme_color_purple': 'Mystic Purple',
    'theme_color_pink': 'Romantic Pink',
    'theme_applies_immediately': 'Theme changes apply immediately',
    
    // Form labels
    'annual_salary_cny': 'Annual Salary (CNY)',
    'annual_salary_foreign': 'Annual Salary (Local Currency)',
    'annual_salary': 'Annual Salary',
    'salary_unit_wan': '10,000 CNY',
    'salary_unit_yuan': 'CNY',
  ...
  ja: {
    ...
    'theme_dark': 'ダーク',
    'theme_color': 'カラーテーマ',
    'theme_color_orange': 'ビビッドオレンジ',
    'theme_color_blue': 'ビジネスブルー',
    'theme_color_green': 'ナチュラルグリーン',
    'theme_color_purple': 'ミスティックパープル',
    'theme_color_pink': 'ロマンチックピンク',
    'theme_applies_immediately': 'テーマ変更はすぐに反映されます',
    
    // フォームラベル
    'annual_salary_cny': '年収（元）',
    'annual_salary_foreign': '年収（現地通貨）',
    'annual_salary': '年収',
    'salary_unit_wan': '万元（人民元）',
    'salary_unit_yuan': '人民元',
